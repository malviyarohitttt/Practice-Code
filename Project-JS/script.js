function createHeader() {
  ...
  searchInputContainer.setAttribute(
    "class",
    "d-flex align-items-center justify-content-center col-md-6 h-100 border border-primary"
  );
  ...
  optionContainer.setAttribute(
    "class",
    "d-flex justify-content-center align-items-center col-md-3 border border-success h-100"
  );
...
function createCart(data) {
  ...
  for (var product of data) {
    ...
    cartImageDiv.setAttribute("class", "d-flex justify-content-center");

    var cartImage = document.createElement("img");
    cartImage.setAttribute("src", product.thumbnail);
    ...
    cartInfoDiv.setAttribute(
      "class",
      "d-flex justify-content-center flex-column pl-1"
    );
    ...
    cart.appendChild(cartImageDiv);
    cartImageDiv.appendChild(cartImage);
    cart.appendChild(cartInfoDiv);
    cartInfoDiv.appendChild(pName);
    cartInfoDiv.appendChild(pPrice);
    cartInfoDiv.appendChild(pRating);
    cartInfoDiv.appendChild(pDiscription);
  }
...
function getData() {
  return [
    ...
    },
    {
      ...
      title: "Huawei P30",
      description:
        "Huawe is re-badged P30 Pro New Edition was officially unveiled yesterday in Germany and now the device has made its way to the UK.",
      price: 499,
