function search(keywords) {
 ...
 function createHeader(searchInputData) {
   ...
   headerDivElement.setAttribute(
     "style",
     "height:70px; position:fixed; width:100%; z-index:99; padding:0 70px "
   );
   headerDivElement.setAttribute(
     "class",
     "bg-dark row d-flex justify-content-between align-items-center"
   );
   ...
   searchInputContainer.setAttribute("style", "width: 60%; text-align: center;");
   ...
   searchInput.setAttribute(
     "style",
     "width:80%;padding:0 20px; height:40px; border-radius:5px; border:none;"
   );
   ...
   if (!sessionStorage.getItem("isLoggedIn")) {
     ...
     viewCartOption.addEventListener("click", function () {
       ...
       orderDiv.setAttribute(
         "class",
         "col-md-4 offset-1 d-flex flex-column justify-content-center align-items-center"
       );
       orderDiv.setAttribute(
         "style",
         "height:fit-content; border: 1px solid black;"
       );
 ...
 function orderComponent(orderDiv) {
   ...
   placeOrderButton.setAttribute(
     "class",
     "btn btn-outline-secondary mt-1 w-100"
   );
 ...
 function generateForm(buttonText) {
   ...
   colDiv.setAttribute(
     "class",
     "col-md-5 border border-success d-flex justify-content-center align-items-center flex-column"
   );
   ...
   formHeading.setAttribute("class", "text-center text-primary");
   colDiv.appendChild(formHeading);
   ...
   var haveAcc = document.createElement("p");
   if (buttonText == "Sign Up") {
     haveAcc.innerHTML =
       "Already have an account? <span onclick='generateForm(\"Sign In\")' class='text-success'>Sign In</span>";
     haveAcc.setAttribute("class", "text-center");
     haveAcc.setAttribute("style", "margin-top:10px; cursor:pointer;");
     colDiv.appendChild(haveAcc);
   } else {
     haveAcc.innerHTML =
       "Don't hava an account? <span onclick='generateForm(\"Sign Up\")' class='text-success'>Sign Up</span>";
     haveAcc.setAttribute("class", "text-center");
     haveAcc.setAttribute("style", "margin-top:10px; cursor:pointer;");
     colDiv.appendChild(haveAcc);
   }
 ...
 function createCart(data) {
   ...
   for (let product of data) {
     ...
     cart.setAttribute(
       "class",
       "border border-success d-flex flex-column align-items-center"
     );
     cart.setAttribute("style", "height:420px;");
 ...
 function viewProductDescriptionComponent(product) {
   ...
   for (let i = 0; i < 4; i++) {
     ...
     imgElement.setAttribute(
       "style",
       "height:100px; width:18%; margin-left:20px; margin-top:20px;"
     );
